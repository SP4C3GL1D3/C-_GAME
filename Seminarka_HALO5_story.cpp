#include <iostream>
// #include <cstdlib> je možné do toho zapojit měnící se proměnné nvm funguje to i bez toho  
#include <stdio.h>
#include <stdlib.h>
#include <time.h>
using namespace std;

// celý kód je vlastně While, If a Switch + trochu logiky + You.com uvařilo příběh byl jsem moc línej to výmýšlet z hlavy
...
int main() {
    ...
    cout << "\n\n\n";
    // Tohle je alternativní příběh HALO 5 kdy Locke se znovu sejde s Master Chiefem
    // a ano viděl jsem nedávný seriál HALO který za to stojí. doporučuji 8,5/10 :)
    // seriál byl hlavní nápad pro tento příběh. sice to s tím nemá nic moc společného ale origo příběh je z hry HALO
    // kód jsem psal v angličtině protože je to jednodušší na vysvětlení než v češtině jelikož seriál i hru jsem viděl a hrál v angličtině
    // GOOD LUCK SPARTAN ! :ThumbsUp:
    ...
    while (enter != 0) {
        ...
        cout << "Please enter 0 to proceed.\n";
        cin >> enter;
        // zde se po zápisu 0 provede posunutí v příběhu ps. ano bude se muset pořád mačkat 0
    }
    ...
    cout << "Now you are going to be able to choose your own answers !\n";
    cout << " ----------------------------------------------------------------- \n";
    cout << "| 1) \"wir kommst treffa !!!\"                                   |\n";
    cout << "| 2) \"Hello There!\"                                               |\n";
    ...
    // zde v příběhu již budou vaše odpovědi ovlivňovat příběh 
    ...
    // problém s while loopem == někdy jde do nekonečna někdy ne nevim co s tim send help
    ...
    cout << "Yo Yo Yo, admin vojtikovec zde.\n";
    cout << "Ted uz budou tvoje odpovedi valid.\n";
    cout << "takze vsechny odpovedi budou dost ovlivnovat ending.\n";
    cout << "GL SPARTAN ! :) \n";
    ...
    if (question3 == 1) {
        ...
        srand((unsigned)time(NULL)); // zde jsem si musel pomoct internetem == Inicializace generátoru náhodných čísel (každý běh programu vygeneruje jinou posloupnost náhodných čísel)
        ...
        while (eternalHP >= 1) {
            ...
            if (randEvent == 0) {
                ...
                return 0;
            } // měl by se zde provést loop dokud "warden" nebo "ty" není mrtev
        } // konec loopu
    ...
    { 
        ...
        else if (question5 == 2) {    //UNSC rozkazy, docela meh ending
        ...
        else if (question5 == 3) {   // spojíš se s master chiefem == very nice ending :)
